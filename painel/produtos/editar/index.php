...
<?php
  ...
  if( $formdata ) {
    ...
    if( !$checkerrors ) {
      ...
      if( edit_produto( $id,$eid,$categoria,$destaque,$estoque,$posicao,$ref,$nome,$descricao,$valor,$oferta,$valor_promocional,$variacao,$status,$visible,$integrado,$pesofrete,$alturafrete,$largurafrete,$comprimentofrete,$diametrofrete ) ) {
