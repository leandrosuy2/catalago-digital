<nav class="navbar pull-left">
	<ul class="nav navbar-nav">
		...
		<li class="active"><a href="https://api.whatsapp.com/send?text=Aderi a *Shopping Place* para ter uma loja virtual para minha empresa integrado com o WhatsApp, cadastre-se vc tb e teste por 15 dias sem compromisso, venha conhecer essa ferramenta maravilhosa. Eu estou gostando muito, *clique no link:* https://reidoscript.com/comece/?afiliado=<?php echo user_info('email'); ?>">Indique 1 amigo</a></li>
		<!--
