  ...
  if( $formdata ) {
    ...
    // Setar campos
      ...
      // Dados gerais
        ...
        $calcularfrete = mysqli_real_escape_string( $db_con, $_POST['calcularfrete'] );
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <label>Calcular frete com correios?</label>
                        <div class="form-field-radio">
                          <input type="radio" name="calcularfrete" value="1" <?php if( $dataestabelecimento['calcularfrete'] == 1 ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                          <input type="radio" name="calcularfrete" value="2" <?php if( $dataestabelecimento['calcularfrete'] == 2 OR !$dataestabelecimento['calcularfrete']){ echo 'CHECKED'; } ?>> Não
                        </div>
                        <div class="clear"></div>
