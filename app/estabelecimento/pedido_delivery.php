                               ...
                               <?php if(data_info('estabelecimentos',$eid,'calcularfrete')=='2'){?>
                                ...
                                <?php }else{ ?>
                                    <table style="margin-bottom:10px">
                                        ...
                                        <tr>
                                            <td style="padding-right:10px"><input class="maskcep" type="text" name="endereco_cep" placeholder="CEP" <?php if(isset($_COOKIE['cep'])){ ?> value="<?php print $_COOKIE['cep']; ?>" <?php } else { ?> value="<?php echo htmlclean( $_SESSION['checkout']['endereco_cep'] ); ?>" <?php } ?>></td>
                                            <td>
                                                <button class="botao-acao" onclick="calculaFrete(this); return false">
                                                Calcular frete</button></td>
                                        </tr>
                                    </table>
                                <?php } ?>
