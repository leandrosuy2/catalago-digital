...
class Frete {
	...
	public function __construct(
		...
		$this->xml = simplexml_load_file(
			Frete::URL."nCdEmpresa=".$empresa."&sDsSenha=".$senha."&sCepOrigem=".$CEPorigem."&sCepDestino=".$CEPdestino."&nVlPeso=".$peso."&nCdFormato=".$tipofrete."&nVlComprimento=".$comprimento."&nVlAltura=".$altura."&nVlLargura=".$largura."&sCdMaoPropria=n&nVlValorDeclarado=".$valor."&sCdAvisoRecebimento=n&nCdServico=".$servico."&nVlDiametro=0&StrRetorno=xml");
